                ...
                <div class="bg-gray-800 border border-gray-700 shadow-lg rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                                ...
                                <?php foreach ($cars as $car) : ?>
                                    <div class="flex items-center p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors border border-gray-600">
                                        ...
                                        <div class="ml-4 flex space-x-2">
                                            ...
                                            <button class="p-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors" title="Xoá">
                                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-600">
                            <a href="#" class="inline-flex items-center text-blue-400 hover:text-blue-300 text-sm font-medium">
